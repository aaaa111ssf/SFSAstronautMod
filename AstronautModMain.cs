...
{
    public class AstronautModMain : Mod
    {
        ...
        {
            HarmonyInstance = new Harmony("com.sfs.astronautmod");
        ...
        public override void Load()
        {
            ...
            GameObject driverObj = new GameObject("__AstronautModUpdater");
        ...
        private static void OnBuildSceneLoaded(UnityEngine.SceneManagement.Scene scene)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 187", e);
            }
        }
        ...
        private static void OnWorldSceneLoaded(UnityEngine.SceneManagement.Scene scene)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 249", e);
            }
        }
        ...
        private static void RetryRestoreAstronauts()
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 298", e);
            }
        }
        ...
        private static void EnsureRockSelector()
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 316", e);
            }
        }
        ...
        private static void EnsureFlagPrefab()
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 353", e);
            }
        }
        ...
        private static void ModifyDisableParts()
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 375", e);
            }
        }
    ...
    /// 场景切换时磁盘/缓存里的名册可能还是旧的（异步保存、DevSettings 跳过写入等）。
                                ...
                                if (resumeRT != null)
                                {
                                    ...
                                    if (sfsBtn != null)
                                    {
                                        ...
                                        if (clickEventField != null)
                                        {
                                            ...
                                            MethodInfo callbackMethod = typeof(AstronautModMain)
        ...
        private static string ModConfigPath
        {
            get
            {
                ...
                {
                    ModLogger.ErrorOnce("AstronautModMain.cs line 693", e);
                }
    ...
    /// Re-reads the persisted configuration of a part and rebuilds its injected CrewModule.
        ...
        public static void OpenCrewCapacityMenu(Part part)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 932", e);
            }
        }
        ...
        private static void RefreshCrewModuleState(CrewModule crew)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1058", e);
            }
        }
        ...
        public static void InjectCrewModule(Part part)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1185", e);
            }
        }
        ...
        static Vector2 CalcHatchPosition(Part part)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1208", e);
            }
        ...
        public static void RemoveCrewModule(Part part, bool keepPersistedData)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1234", e);
            }
                            }
                        }
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1247", e);
            }
        }
        ...
        public static void ClearModuleCache(Part part)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1264", e);
            }
        }
        ...
        public static void ReopenPartMenu(Part part)
        {
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1286", e);
            }
            ...
            {
                ModLogger.ErrorOnce("AstronautModMain.cs line 1294", e);
            }
        }
    }
}
